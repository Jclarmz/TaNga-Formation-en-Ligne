<?php
// Mot de passe HTML CSS "HcZ/JcMZ_DSe*jc17"
...
if ($mot_de_passe == "HcZ/JcMZ_DSe*jc17") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="courses-singel.html">Cours exceptionnel</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/ban1.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre HTML5 & CSS3</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Créer soi-même son site web avec ces deux langages</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/html-css.jpg" alt="HTML CSS" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>HTML CSS</b> est la formation que vous avez choisie, contenant 3 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à structurer une page web, et lui donner une forme 😊<br />
                              ...
                              Pour la petite présentation, je suis Monsieur <a href="http://declausoft.net/MonPortfolio" style="color: #ed7f10;">Declau</a>, votre formateur 😊<br />
                              Cliquez sur le bouton ci-dessous pour commencer.
                            </p>
                            <!-- <h2>Keep in touch</h2> -->
                        </div> <!-- section title -->
                        <div class="main-form pt-45">
                            <form action="cours-html-css2.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">HTML5 CSS3</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-html-css.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
