<?php
// Mot de passe Gimp "DeC-01*DSe/PiMg_jcM"
...
if ($mot_de_passe == "DeC-01*DSe/PiMg_jcM") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/gimp.gif)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre GIMP</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">&Eacute;diter ses images</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/gimp/gimp.gif" alt="Gimp" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>GIMP</b> est la formation que vous avez choisie.<br />
                               Au cours de cette formation, je vais vous apprendre à retoucher vos images 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="gimp.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Gimp</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-gimp2.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
