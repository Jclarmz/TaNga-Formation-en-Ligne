...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-130 bg_cover" data-overlay="8" style="background-image: url(images/ban1.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <p style="color: #ed7f10;">Tester son niveau</p>
                            <ol class="breadcrumb">
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            <h5>QCM</h5>
                            <h2>Jaugez votre niveau 😊</h2>
                        </div> <!-- section title -->
                        <div class="main-form pt-45">
                            <form id="contact-form" action="qcmWindows.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="singel-form form-group">
                                            <input name="nom" type="text" placeholder="Votre nom" data-error="Saisissez votre nom s'il vous plaît." required="required">
                                    ...
                                    <div class="col-md-6">
                                        <div class="singel-form form-group">
                                            <input name="nom" type="text" placeholder="Votre prénom" data-error="Saisissez votre prénom s'il vous plaît." required="required">
                                            <div class="help-block with-errors"></div>
                                        </div> <!-- singel form -->
                                    </div>
                                    <div class="col-md-6">
                                        <div class="singel-form form-group">
                                            <input name="email" type="email" placeholder="Votre e-mail" data-error="Saisissez une adresse électronique valide s'il vous plaît." required="required">
                                            <div class="help-block with-errors"></div>
                                        </div> <!-- singel form -->
                                    </div>
                                    <div>
   ...
   <script type='text/javascript' data-cfasync='false'>window.purechatApi = { l: [], t: [], on: function () { this.l.push(arguments); } }; (function () { var done = false; var script = document.createElement('script'); script.async = true; script.type = 'text/javascript'; script.src = 'https://app.purechat.com/VisitorWidget/WidgetScript'; document.getElementsByTagName('HEAD').item(0).appendChild(script); script.onreadystatechange = script.onload = function (e) { if (!done && (!this.readyState || this.readyState == 'loaded' || this.readyState == 'complete')) { var w = new PCWidget({c: '3a03591c-c066-4fb9-bde4-ea1dd4bf872f', f: true }); done = true; } }; })();</script>
    ...
    <script type="text/javascript">
        function updateClock() {
            ...
            // Add a leading zero to the date/month/hours/minutes/seconds if they are single digits
       ...
       // Run the updateClock function every 1 second
