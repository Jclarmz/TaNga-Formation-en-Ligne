<?php
// Mot de passe Créer un GIF "nim@A-17*FgiDS-e/"
...
if ($mot_de_passe == "nim@A-17*FgiDS-e/") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/gds.gif)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre à Créer un Gif</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">En quelques clics, animez vos images</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/gif/gds.gif" alt="Créer un gif" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Créer un gif</b> est la formation que vous avez choisie, contenant quelques modules.<br />
                               Au cours de cette formation, je vais vous apprendre à animer vos image de façon répétitive en quelques clics 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="gif.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Créer un Gif</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-creer-gif2.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
