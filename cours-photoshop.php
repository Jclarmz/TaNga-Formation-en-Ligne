<?php
// Mot de passe Photoshop "OPh_OT@Psho_17_DSe*"
...
if ($mot_de_passe == "OPh_OT@Psho_17_DSe*") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/word2.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre Photoshop</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">&Eacute;diter ses images avec Photoshop</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/photoshop2.png" alt="Photoshop" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Photoshop</b> est la formation que vous avez choisie, contenant plus de 10 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à créer et/ou éditer vos images avec Photoshop 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="cours-photoshop2.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Photoshop</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-photoshop.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
