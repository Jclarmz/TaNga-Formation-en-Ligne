    ...
    <section id="about-page" class="pt-70 pb-110">
        <div class="cours">
            ...
            <?php
                ...
                echo "<p>Désolé, la réponse correcte était : <i>Le Bureau.</i></p>";
                }
                ...
                echo "<p>Désolé, la réponse correcte était : <i>Accéder aux programmes.</i></p>";
                }

                // Récupération de la réponse de l'utilisateur
                $answer = $_POST['methode'];
  
                // Vérification de la réponse
                if ($answer == "lancer") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était : <i>Saisir Word depuis la barre de recherche Windows, Double-cliquer sur son icône si elle se retrouve sur le Bureau, ...</i></p>";
                }
            ?>
