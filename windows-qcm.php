...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/course/windows2.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <p style="color: #ed7f10;">Tester ce que vous avez appris 😇</p>
                            <ol class="breadcrumb">
                                <!-- <li class="breadcrumb-item"><a href="index.html">Accueil</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Nous</li> -->
                            </ol>
                        </nav>
    ...
    <section id="about-page" class="pt-70 pb-110">
        <div class="cours">
            ...
            <?php
                ...
                if ($answer == "logiciel") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était : <i>un logiciel.</i></p>";
                }

                // Récupération de la réponse de l'utilisateur
                $answer = $_POST['verrouillage'];
  
                // Vérification de la réponse
                if ($answer == "eve") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était : <i>C'est le tout premier écran qui s'affiche lorqu'on allume un ordinateur.</i></p>";
                }
                ...
                echo "<p>Désolé, la réponse correcte était : <i>&Agrave; saisir le mot de passe de son ordinateur.</i></p>";
                }

                // Récupération de la réponse de l'utilisateur
                $answer = $_POST['windows10'];
  
                // Vérification de la réponse
                if ($answer == "oui") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était : <i>Oui.</i></p>";
                }

                // Récupération de la réponse de l'utilisateur
                $answer = $_POST['mdportail'];
                ...
                echo "<p>Désolé, la réponse correcte était : <i>C'est le gestionnaire du contenu de l'ordinateur.</i></p>";
                }
                ...
                echo "<p>Désolé, la réponse correcte était : <i>La barre des tâches permet de lancer le menu Démarrer, d’effectuer une recherche sur son ordinateur, d’afficher des raccourcis vers ses programmes préférés, d’afficher des notifications d’applications ou encore des notifications de Windows.</i></p>";
                }
            ?>
            ...
            <p>
                Copier votre résultat, puis le coller à l'adresse suivante : <b><i>contact@tangads.com</i></b>.<br />
                Comme Objet, saisir : <b><i>Mes résultats</i></b>.
            </p>
