<?php
// Mot de passe Montage vidéo "D_oiv@D2t*Ageomn"
...
if ($mot_de_passe == "D_oiv@D2t*Ageomn") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/montage_video3.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre le Montage vidéo</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Apprendre à monter sa vidéo soi-même</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/montage_video/montage_video2.png" alt="Montage vidéo" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Montage vidéo</b> est la formation que vous avez choisie, contenant quelques modules.<br />
                              Au cours de cette formation, je vais vous apprendre à monter une vidéo à travers une et/ou plusieurs images 😊<br />
                              Ce petit guide a été rédigé surtout pour les grands débutants, aussi pour ceux qui souhaitent parfaire leur connaissance.<br />
                              Pour la petite présentation, je suis Monsieur <a href="http://https://tangads.com/MonPortfolio" style="color: #ed7f10;">Declau</a>, votre formateur 😊<br />
                              Cliquez sur le bouton ci-dessous pour commencer.
                            </p>
                            <!-- <h2>Keep in touch</h2> -->
                        </div> <!-- section title -->
                        <div class="main-form pt-45">
                            <form action="montage-video.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Montage vidéo</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            <h5>Mot de passe</h5>
                            <p>
                              Veuillez entrer le mot de passe que vous avez reçu par mail, lors de votre inscription.<br />Un mauvais mot de passe vous redirige vers cette même page.
                            </p>
                            <!-- <h2>Keep in touch</h2> -->
                        </div> <!-- section title -->
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-montage-video.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="singel-form form-group">
                                            <input name="mot_de_passe" type="password" placeholder="Mot de passe" data-error="Le mot de pase est obligatoire" required="required">
