    ...
    <section id="about-page" class="pt-70 pb-110">
        <div class="cours">
            ...
            <?php
                ...
                $answer = $_POST['colonne'];
  
                // Vérification de la réponse
                if ($answer == "champ") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était : <i>Champ.</i></p>";
                }
                ...
                // Vérification de la réponse
                if ($answer == "enregistrement") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était : <i>un enregistrement.</i></p>";
                }

                // Récupération de la réponse de l'utilisateur
                $answer = $_POST['bddonnees'];
