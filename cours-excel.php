<?php
// Mot de passe Excel "xX-06*DSe/celXjcM"
...
if ($mot_de_passe == "xX-06*DSe/celXjcM") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/exceltanga.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre Excel</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Manipuler une feuille de calcul</p>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/excel/iconeExcel.jpg" alt="Excel" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Excel</b> est la formation que vous avez choisie, contenant plus de 3 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à manipuler une feuille de calcul 😊<br />
                              ...
                              Pour la petite présentation, je suis Monsieur <a href="https://tangads.com/MonPortfolio" style="color: #ed7f10;">Declau</a>, votre formateur 😊<br />
                              Cliquez sur le bouton ci-dessous pour commencer.
                            </p>
                            <!-- <h2>Keep in touch</h2> -->
                        </div> <!-- section title -->
                        <div class="main-form pt-45">
                            <form action="cours-excel2.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Excel</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-excel.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
