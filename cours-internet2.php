<?php
// Mot de passe Internet "1netR-17*@DS-e/dec_d2j@M"
...
if ($mot_de_passe == "1netR-17*@DS-e/dec_d2j@M") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/internet4.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre Internet</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">En un clic, ayez le monde entre vos mains</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/internet/internet2.jpg" alt="Internet" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Internet</b> est la formation que vous avez choisie, contenant 3 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à être en contact avec le monde en un clic 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="internet.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Internet</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-internet2.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
