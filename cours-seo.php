<?php
// Mot de passe SEO "OpZti-17*T6@DS-e/"
...
if ($mot_de_passe == "OpZti-17*T6@DS-e/") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/seo.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre le SEO</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Optimiser votre site web</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/seo/seo.png" alt="SEO" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>SEO</b> est la formation que vous avez choisie, contenant quelques modules.<br />
                               Au cours de cette formation, je vais vous apprendre à optimiser un site web 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="seo.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">SEO</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-seo.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
