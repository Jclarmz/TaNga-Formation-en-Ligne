<?php
// Mot de passe Windows "wIn-17*dOWs-e/dec_d2j@M"
...
if ($mot_de_passe == "wIn-17*dOWs-e/dec_d2j@M") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/windows2.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre Windows</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Manipuler son ordinateur afin de se familiariser avec</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/windows/windows2.png" alt="Windows" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Windows</b> est la formation que vous avez choisie, contenant plus de 3 modules.<br />
                              Au cours de celui-ci, je vais vous apprendre à vous familiariser avec votre ordinateur 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="windows.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Windows</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-windows2.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
