<?php
// Mot de passe PHP "_DSe*hPp/17aV7219D"
...
if ($mot_de_passe == "_DSe*hPp/17aV7219D") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/php2.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Rendre un site web dynamique</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/php2.png" alt="PHP" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>PHP</b> est la formation que vous avez choisie, contenant 7 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à rendre dynamique une page web 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="cours-php2.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">PHP</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-php.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
