<?php
// Mot de passe Access "a2cE2s-17*bdd-e/dec_d2j@M"
...
if ($mot_de_passe == "a2cE2s-17*bdd-e/dec_d2j@M") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/access4.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre Access</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Apprendre à stocker et à gérer de vaste ensembles d’informations</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/access/access2.jpg" alt="Access" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Access</b> est la formation que vous avez choisie, contenant 4 modules.<br />
                              Au cours de cette formation, je vais vous apprendre à stocker et à gérer de vastes ensembles d’informations 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="cours-access2.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Access</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-access.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
