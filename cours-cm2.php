<?php
// Mot de passe CM "/9127-17Cm_DSe*_@"
...
if ($mot_de_passe == "/9127-17Cm_DSe*_@") // Si le mot de passe est bon
{
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre Community Management</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Les clés pour devenir Community Manager</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/cm2.png" alt="CM" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Community Management</b> est la formation que vous avez choisie, contenant 5 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à marquer la forte réputation de votre structure sur les réseaux sociaux 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="cm.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Community Management</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-cm2.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
