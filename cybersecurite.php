<?php
// Mot de passe Cybersécurité "6ber@-_CqTdSe"
...
if ($mot_de_passe == "6ber@-_CqTdSe") // Si le mot de passe est bon
{
...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(images/csTanga2.png)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre la Cybersécurité</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Protection des systèmes informatiques et des réseaux</p>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/cybersecurite/csTanga2.png" alt="Cybersécurité" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Cybersécurité</b> est la formation que vous avez choisie, contenant plus de 3 modules.<br />
                               Au cours de cette formation, je vais vous apprendre la protection des systèmes informatiques et des réseaux. 😊<br />
                              ...
                              Pour la petite présentation, je suis Monsieur <a href="http://declau.online" style="color: #ed7f10;">Declau</a>, votre formateur 😊<br />
                              Cliquez sur le bouton ci-dessous pour commencer.
                            </p>
                            <!-- <h2>Keep in touch</h2> -->
                        </div> <!-- section title -->
                        <div class="main-form pt-45">
                            <form action="cours-cybersecurite.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Cybersécurité</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cybersecurite.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
