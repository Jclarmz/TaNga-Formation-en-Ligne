<?php
// Mot de passe AR "/9_1_27-17aR_DSe*_@"
...
if ($mot_de_passe == "/9_1_27-17aR_DSe*_@") // Si le mot de passe est bon
{
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre l'Administration des Réseaux</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">La gestion des réseaux informatiques</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/ar/ar4.jpg" alt="AR" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Administration des Réseaux</b> est la formation que vous avez choisie, divisée en 3 parties, dont celle-ci contenant 7 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à gérer les comptes et les machines d'un réseau informatique 😊<br />
                              ...
                              Pour la petite présentation, je suis Monsieur <b>Mouissi</b>, votre formateur 😊<br />
                              Cliquez sur le bouton ci-dessous pour commencer.
                            </p>
                            <!-- <h2>Keep in touch</h2> -->
                        </div> <!-- section title -->
                        <div class="main-form pt-45">
                            <form action="cours-ar2.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Administration des réseaux</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-ar.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
