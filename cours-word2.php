<?php
// Mot de passe Word "zZ_@DorW_05_DSe*"
...
if ($mot_de_passe == "zZ_@DorW_05_DSe*") // Si le mot de passe est bon
{
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Apprendre Word</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <p style="color: #ed7f10;">Manipuler un traitement de texte</p>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            ...
                            <p>
                              <img src="images/course/word2.png" alt="Word" style="width: 100px; height: 100px; border-radius: 200px; border: 0px #ed7f10 solid; float: left; padding: 5px;"><b>Word</b> est la formation que vous avez choisie, contenant 12 modules.<br />
                               Au cours de cette formation, je vais vous apprendre à manipuler un traitement de texte 😊<br />
                        ...
                        <div class="main-form pt-45">
                            <form action="word.html" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" class="main-btn">Word</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        ...
                        <div class="main-form pt-45">
                            <form id="contact-form" action="cours-word2.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-6">
