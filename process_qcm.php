    ...
    <section id="about-page" class="pt-70 pb-110">
        <div class="cours">
            ...
            <?php
                ...
                $answer = $_POST['ordinateur'];
  
                // Vérification de la réponse
                if ($answer == "oui") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était Oui.</p>";
                }

                // Récupération de la réponse de l'utilisateur
                $answer = $_POST['composants'];
  
                // Vérification de la réponse
                if ($answer == "cpu") {
                echo "<p>Bravo, vous avez répondu correctement !</p>";
                } else {
                echo "<p>Désolé, la réponse correcte était : <i>Un ordinateur est principalement composé d’un écran, d’un clavier, d’une souris et d’une unité centrale, qui elle-même contient un microprocesseur qui exécute les programmes chargés dans sa RAM. La RAM représente la mémoire active de l’ordinateur ; elle est effacée lorsqu’on éteint la machine.</i></p>";
                }

                // Récupération de la réponse de l'utilisateur
                $answer = $_POST['windows'];
                ...
                echo "<p>Désolé, la réponse correcte était : <i>Le rôle d'un ordinateur est de traiter de l'information et de faciliter l'exécution de tâches en utilisant des programmes informatiques.</i></p>";
                }
            ?>
            ...
            <!-- <?php
                ...
                // Convertir la chaîne en objet PHP
                $results = json_decode($json);

                // Afficher chaque réponse du questionnaire
